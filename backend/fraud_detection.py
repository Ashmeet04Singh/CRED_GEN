...
pipeline = joblib.load("lof_pipeline.pkl")
...
# dummy_data = {'name_list': ['Rohit Sharma', 'Rohit K Sharma', 'Sharma Rohit'],'dob': '12-22-1995','address': 'Delhi','salary': 85000,'emi_to_income_ratio': 0.28,'debt_to_income_ratio': 0.35,'active_loans': 2,'requested_loan_amount': 450000}

# print(predict_fraud(dummy_data))