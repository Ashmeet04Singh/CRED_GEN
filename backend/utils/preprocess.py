...
def validate_amount(amount):
    ...
    from backend.utils.config import MIN_LOAN_AMOUNT, MAX_LOAN_AMOUNT
...
def validate_age(age):
    ...
    from backend.utils.config import MIN_AGE, MAX_AGE
...
def validate_tenure(tenure):
    ...
    from backend.utils.config import MIN_TENURE, MAX_TENURE
